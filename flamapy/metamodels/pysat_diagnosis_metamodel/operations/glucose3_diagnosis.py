...
from flamapy.metamodels.pysat_diagnosis_metamodel.operations.diagnosis.hsdag.labeler.fastdiag_labeler import FastDiagParameters, \
    FastDiagLabeler
...
class Glucose3Diagnosis(Operation):
    ...
    def execute(self, model: VariabilityModel) -> 'Glucose3Diagnosis':
        ...
        parameters = FastDiagParameters(C, [], model.get_B())
